...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Download FunASR model dependencies.")
    parser.add_argument(
        "--profile",
        action="append",
        dest="profiles",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Override the model cache directory. Defaults to FUNASR_MODEL_CACHE_DIR.",
    )
    return parser
